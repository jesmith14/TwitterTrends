...
class TwitterAPI():
    ...
    def addTrendsToDB(self):
        ...
        print('***adding this to the trends DB:')
        print('time: ', time)
        print('trends array: ', trends)
...
class MyStreamListener(tweepy.StreamListener):
    ...
    def addNewTweetToDB(self, newData):
        ...
        print("###adding this to the tweets DB:", newData)
    ...
    def on_data(self, data):
        ...
        #I want to call this function once every 5 minutes
#         if self.tweet_count % 1000 == 0:
#             self.addTrendsToDB()
